...
const Login = ({ authHandler }) => {
    const [signin, { isLoading, isSuccess, isError, error }] = useLazySigninQuery()
    ...
    useEffect(() => {
        if (isError) {
            toast.error(error ? error.message : "Login Fail!")
        }
    }, [isError])
    if (isLoading) {
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 offset-sm-3">
                    <div class="card mt-3">
                        <div class="card-header alert alert-warning text-center fs-3">
                            Login
                        </div>
                        <div class="card-body">
                            <div>
