...
import { useAddStudentMutation, useDeleteStudentMutation, useGetStudentsQuery, useUpdateStudentMutation } from '../../redux/apis/tpo.api'
...

                                    {
                                        item.active
                                            ? <button
                                                ...
                                                onClick={() => handleUpdate({ ...item, active: false })}
                                            >
                                                Block
                                            </button>
                                            : <button
                                                ...
                                                onClick={() => handleUpdate({ ...item, active: true })}
                                            >
                                                UnBlock
                                            </button>
                                    }
